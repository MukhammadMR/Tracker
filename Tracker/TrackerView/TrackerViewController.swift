...
final class TrackerViewController: UIViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        AnalyticsService.shared.logEvent(event: "open", screen: "main")
    }
    
    override func viewDidDisappear(_ animated: Bool) {
        super.viewDidDisappear(animated)
        AnalyticsService.shared.logEvent(event: "close", screen: "main")
    }
    ...
    private func addButtonTapped() {
        AnalyticsService.shared.logEvent(event: "click", screen: "main", item: "add_track")
    ...
    private func filterButtonTapped() {
        AnalyticsService.shared.logEvent(event: "click", screen: "main", item: "filter")
    ...
    func collectionView(_ collectionView: UICollectionView, contextMenuConfigurationForItemAt indexPath: IndexPath, point: CGPoint) -> UIContextMenuConfiguration? {
        ...
        return UIContextMenuConfiguration(identifier: indexPath as NSCopying, previewProvider: nil) { _ in
            ...
            let edit = UIAction(title: NSLocalizedString("edit_action", comment: "Редактировать"), image: UIImage(systemName: "pencil")) { [weak self] _ in
                AnalyticsService.shared.logEvent(event: "click", screen: "main", item: "edit")
                guard let self = self else { return }
            ...
            let delete = UIAction(title: NSLocalizedString("delete_action", comment: "Удалить"), image: UIImage(systemName: "trash"), attributes: .destructive) { [weak self] _ in
                AnalyticsService.shared.logEvent(event: "click", screen: "main", item: "delete")
                guard let self = self else { return }
